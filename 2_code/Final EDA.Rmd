...
```{r review_scores_communication_, echo=FALSE, message=FALSE, warning=FALSE}
...
```{r review_scores_value bar, echo=FALSE, message=FALSE, warning=FALSE}
...
smp_size <- floor(0.70 * nrow(inp))

## set the seed to make your partition reproducible
set.seed(123)
train <- sample(seq_len(nrow(inp)), size = smp_size)
